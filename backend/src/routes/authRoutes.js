...
import { getCurrentUser, loginAdmin, loginCandidate, loginRecruiter, registerCandidate, registerRecruiter } from "../controllers/authController.js";
...
router.post("/admin/login", validate(recruiterLoginSchema), loginAdmin);
